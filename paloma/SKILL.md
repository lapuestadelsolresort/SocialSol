...
| Channel | ID | Purpose |
|---|---|---|
| #mantenimiento (repairs) | `C062S7C1QGH` | Broken items, repair requests. Sergio responds with status. |
| #limpieza (cleaning/daily) | `C06MH0K9QRF` | Daniel documents daily tasks (cleaning, upkeep). |
| #paloma-tracker | `C0BN440C2BA` | Paloma's summary channel (visible to Jason, Mayela, team). |

## People

| Person | Slack ID | Role | Language |
|---|---|---|---|
| Sergio Gracia | `U05E58FHHJP` | Maintenance / repairs | Spanish only |
| Daniel García | `U05E43W979D` | Daily operations / cleaning | Bilingual |
| Mayela Gomez | `U06AWTZH1V1` | Manager (on-site ~1x/week) | Bilingual |
| Jason Starkey | `U05EVK2GV5X` | Owner | English only |
