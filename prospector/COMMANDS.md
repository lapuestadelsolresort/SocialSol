...
<!-- BEGIN GENERATED: durable workflows on the prospector-paulina surface — regenerate with `npm run docs:commands` -->

### Durable workflows — Prospector Paulina
...
| `paulina.performance.read` | `paulina.read` | read-only | agent tool |
| `paulina.prepare_daily` | `paulina.prepare` | mutates · autonomous | scheduled |
